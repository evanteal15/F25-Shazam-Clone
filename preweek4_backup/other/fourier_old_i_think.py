...
def manual_stft(audio, sr):
    ...
    # hop_length == scipy.signal's nstep I think
    ...
    #num_segs = (sl - nperseg) // hop_length + 2
...
signal_synth, sr = librosa.load("./synth.wav", sr=1000)

plot_stft_comparison(signal_test, sr)
print("***************8")
print("***************8")
plot_stft_comparison(signal_synth, sr)
